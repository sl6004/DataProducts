    ...
    mainPanel(
      ...
      tabsetPanel (
        ...
        ("Application Information",
         ...
         h4('Based on the previously analysis we select the model requires three major variables: weight, horse power, and transmission type.'),
         h4('To use this application, please enter these three required variables on the left panel. The App may take a few seconds to calculate after data entered.'),
